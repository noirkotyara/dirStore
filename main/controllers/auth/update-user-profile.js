...
var updateUserProfile = function (userId, userProfileFieldsToChange, token, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userProfile, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1.default.put("http://localhost:3021/auth/profile", userProfileFieldsToChange, {
                        headers: {
            ...
            case 1:
                ...
                next((0, response_catcher_1.responseCatcher)({
                    ...
                    data: {
                        data: userProfile,
                        message: userProfile.type + " profile " + userProfile.email + " is updated successfully"
                    }
                }));
                return [3 /*break*/, 3];
            case 2:
