...
exports.checkAccessMiddleware = void 0;
...
var checkAccessMiddleware = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var routerType, requesterType, userType, userProfile, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                routerType = req.originalUrl.split("/")[1].toUpperCase();
                requesterType = "";
                _a.label = 1;
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, redisGet("userType:" + req.user.userId)];
            case 2:
                userType = _a.sent();
                if (userType) {
