...
var deleteUserProfileById_1 = require("../../services/auth/deleteUserProfileById");
...
var deleteUserProfile = function (userId, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userProfile, userProfileRedis, deletedRows, isUserDeleted, deletedRowsUserProfileRedis, deletedRowsUserTypeRedis, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                if (!userProfile) {
                    throw new ErrorCatcher_1.ErrorCatcher({
                        responseCode: message_catcher_1.RESPONSE_CODES.P_ERROR__NOT_FOUND,
                        data: "User is not existed",
                    });
                }
                return [4 /*yield*/, (0, deleteUserProfileById_1.deleteUserProfileById)(userId)];
            case 4:
                deletedRows = _a.sent();
